...
cp files/mosquitto1.conf data/mosquitto1/config/mosquitto.conf
cp files/mosquitto2.conf data/mosquitto2/config/mosquitto.conf
cp files/mosquitto3.conf data/mosquitto3/config/mosquitto.conf
